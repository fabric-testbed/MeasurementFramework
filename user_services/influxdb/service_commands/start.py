# Start influxdb serivice by running start_influxdb.yaml
import os
...
def main():
    ...
    if r.returncode == 0:
        ...
        ret_val["msg"] = "Influxdb start playbook ran.."
    else:
        ret_val["success"] =  False
        ret_val["msg"] += "Influxdb start playbook install failed.."
    logging.info(ret_val['msg'])
    ret_val["play_recap"] = play_recap

    logging.info("Influxdb start.yaml playbook completed.")

    logging.info("-----End Influxdb Start Script.-----")
