# Create timestamp service by running create_timestamp_service.yaml
...
def main():
    ...
    playbook = "/home/mfuser/mf_git/user_services/timestamp/playbooks/create_timestamp_service.yaml"
    ...
    if r.returncode == 0:
        ...
        ret_val["msg"] = "Timestamp create playbook ran.."
    else:
        ret_val["success"] =  False
        ret_val["msg"] = "Timestamp create playbook install failed.."
    logging.info(ret_val['msg'])
    ret_val["play_recap"] = play_recap

    logging.info("Timestamp create.yaml playbook completed.")

    logging.info("-----End Timestamp Create Script.-----")
