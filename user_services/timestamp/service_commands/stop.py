# Stop timestamp service by running stop_timestamp_service.yaml
...
def main():
    ...
    playbook = "/home/mfuser/mf_git/user_services/timestamp/playbooks/stop_timestamp_service.yaml"
    ...
    logging.info("-----Start Timestamp Stop Script.-----")
    ...
    if r.returncode == 0:
        ...
        ret_val["msg"] = "Timestamp stop playbook ran.."
    else:
        ret_val["success"] =  False
        ret_val["msg"] = "Timestamp stop playbook install failed.."
    logging.info(ret_val['msg'])
    ret_val["play_recap"] = play_recap

    logging.info("Timestamp stop.yaml playbook completed.")

    logging.info("-----End Timestamp Stop Script.-----")
