...
def main():
    ...
    playbook = "/home/mfuser/mf_git/user_services/data_transfer/playbooks/start_data_transfer.yaml"
    ...
    if r.returncode == 0:
        ...
        ret_val["msg"] = "data transfer start playbook ran.."
    else:
        ret_val["success"] =  False
        ret_val["msg"] += "data transfer start playbook install failed.."
    logging.info(ret_val['msg'])
    ret_val["play_recap"] = play_recap

    logging.info("data transfer start.yaml playbook completed.")

    logging.info("-----End data transfer Start Script.-----")
