...
def main():
    ...
    playbook = "/home/mfuser/mf_git/user_services/data_transfer/playbooks/remove_data_transfer.yaml"
    ...
    logging.info("-----Start data transfer Delete Script.-----")
    ...
    if r.returncode == 0:
        ...
        ret_val["msg"] = "data transfer delete playbook ran.."
    else:
        ret_val["success"] =  False
        ret_val["msg"] = "data transfer delete playbook install failed.."
    logging.info(ret_val['msg'])
    ret_val["play_recap"] = play_recap

    logging.info("data transfer delete.yaml playbook completed.")

    logging.info("-----End data transfer Delete Script.-----")
